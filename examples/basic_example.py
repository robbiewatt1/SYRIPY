...
# This example shows how SYRIPY can be used to simulate the production of
# edge radiation in the centre of a bunch compressor. We first simulate a
# particle track. Then we use this track to solve the field. Finally, we
# propagate the field to the focal plane of a lens and plot the intensity.
